...
const [catalogPath, imageOutputDir, stagedCatalogPath, publicBase = "https://images.boardgameb2b.com/images/catalog"] = process.argv.slice(2);
...
const sourceUrls = [...urls].filter((value) => {
  try { return !new Set(["boardgameb2b.com", "images.boardgameb2b.com", "www.boardgameb2b.com", "desktop-game.ocbinks.workers.dev"]).has(new URL(value).hostname); }
  catch { return false; }
});
